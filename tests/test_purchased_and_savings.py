...
def test_the_done_window_names_items_not_yet_marked(signed_in, items):
    ...
    assert "1 item is not marked as purchased" in html and items[1].ItemName in html
    signed_in.post(f"/api/list/items/{items[1].ListItemId}/purchased", json={"purchased": True})
